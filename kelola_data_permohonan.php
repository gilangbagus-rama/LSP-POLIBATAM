...
<head>
  ...
  <title>SI-LSP | Kelola Data Permohonan</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        // Cek Status permohonan
          $sql =  $conn->query("SELECT `permohonan`.`file_APL_01`,`permohonan`.`status_permohonan` FROM `permohonan` , `asesi` 
          WHERE permohonan.id_asesi = asesi.id_asesi AND permohonan.id_permohonan = '$id_permohonan'
          ...
          <div class="box box-widget" style="margin-bottom: 10px;background-color: #FDFDFD">
            ...
            <div class="alert alert-success alert-dismissible">
              ...
              <button type="button" class="close" 
                ...
                Permohonan asesmen Anda diterima, silahkan lanjut dengan melakukan <a href="index.php?page=asesmen_mandiri&&id_permohonan=<?php echo $id_permohonan ?>" data-toogle="tooltip" data-placement="top" title="Lanjut Asesmen Mandiri"> Asesmen Mandiri </a>
        ...
        <div class="box box-widget" style="margin-bottom: 10px;background-color: #FDFDFD">
          ...
          <div class="alert alert-success alert-dismissible">
            ...
            <button type="button" class="close" 
              ...
              Mohon Menunggu, Pihak LSP sedang mempersiapkan berkas uji asesmen.
        ...
        <div class="box box-widget" style="margin-bottom: 10px;background-color: #FDFDFD" <?php echo $proses?>>
          ...
          <div class="alert alert-warning alert-dismissible">
            ...
            <button type="button" class="close" 
              ...
              Asesor telah menyiapkan persetujuan asesmen. Silahkan klik disini untuk melakukan persetujuan asesmen. <a href="index.php?page=validasi_persetujuan_asesmen&&id_permohonan=<?php echo $id_permohonan ?>">Persetujuan Asesmen</a>
        ...
        <div class="row">
          ...
          <div class="col col-md-12 col-lg-12">
            ...
            <!-- Judul -->
                <div class="box-body panel-body" style="color: white">
                
                    <h4 class="pull-left text-primary">
                      
                      <i class="fa fa-user"> Permohonan Sertifikasi </i>
                      
                    </h4>

                    <h4 class="pull-right">
                      <a href="./uploads/Asesi/<?php echo $id_asesi?>/<?php echo $id_permohonan?>/<?php echo $data['file_APL_01']?>" target="_blank"><i class="fa fa-file" style="margin-right: 6px;"></i>
                      Lihat File APL-01 </a>
                    </h4>
        ...
        <div class="row" id="PermohonanSertifikasi">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="box box-danger">
                      ...
                      <?php
                        ...
                        AND `permohonan`.`id_asesi` = '$id_asesi' AND `permohonan`.`id_permohonan` = '$id_permohonan';");
            ...
            <div class="panel box">
                ...
                <div id="DataSertifikasi" class="panel-collapse collapse in">
                  ...
                  <?php
                    ...
                    $sql = $conn->query("SELECT `permohonan`.`id_skema`,`permohonan`.`tujuan_asesmen` , `skema_sertifikasi`.`nama_skema` , `skema_sertifikasi`.`nomor_skema`
                    ...
                    $sertifikasi      = mysqli_fetch_assoc($sql); $id_skema = $sertifikasi['id_skema'];
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <div>
                                    ...
                                    <input type="text" class="form-control" disabled value="<?php echo $portofolio['terpenuhi'] ?>"/>
          ...
          <div class="col col-lg-5 panel-group">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group form-row col-md-12">
                      ...
                      <?php
                        ...
                        $sql=$conn->query("SELECT `permohonan`.`rekomendasi` , `permohonan`.`catatan` , `permohonan`.`status_permohonan`
                        FROM `permohonan` , `asesi` WHERE `permohonan`.`id_asesi` = `asesi`.`id_asesi` AND `permohonan`.`id_permohonan` = '$id_permohonan'
                      ...
                      ?>
                        ...
                        Berdasarkan persyaratan dasar pemohon, kandidat dapat :
                          ...
                          <input type="text" disabled class="form-control" value="<?php echo $data['rekomendasi'] ?>"/>
            ...
            <?php
            if ( $data['rekomendasi'] == 'Diterima' || $data['status_permohonan'] == 'Diproses' ) { ?>
                ...
                <div id="DataAsesor" class="panel-collapse collapse in">
                  ...
                  <div class="panel-body">
                    ...
                    <?php
                        ...
                        $sql22=$conn->query("SELECT * FROM `asesmen_mandiri` WHERE `id_permohonan` = '$id_permohonan' ");

                        if ( mysqli_num_rows($sql22) == '1' ){
                          $cek_asesmen_mandiri = 'disabled';
                        }
        ...
        <?php
          ...
          $sql23 = $conn->query("SELECT * FROM `asesmen_mandiri` WHERE `id_permohonan` = '$id_permohonan'");
          $d = mysqli_fetch_assoc($sql23);

          if ( mysqli_num_rows($sql23) == '1' ){
            $hidden = '';
          }

          if ( mysqli_num_rows($sql23) == '0' ){
            $hidden = 'hidden';
          }
          ...
          <div class="col col-md-12 col-lg-12">
            ...
            <div class="box-body panel-body" style="color: white">
                ...
                <h4 class="pull-left text-primary">
                  ...
                  <i class="fa fa-user"> Asesmen Mandiri </i>
                  
                </h4>

                <h4 class="pull-right">
                  <a href="./uploads/Asesi/<?php echo $id_asesi?>/<?php echo $id_permohonan?>/<?php echo $d['file_APL_02']?>" target="_blank"><i class="fa fa-file" style="margin-right: 6px;"></i>
                  Lihat File APL-02 </a>
                </h4>
