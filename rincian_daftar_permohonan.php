...
<head>
  ...
  <title>SI-LSP | Daftar Permohonan</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index.php" class="logo">
        ...
        <img src="img/logo.png" height="50%" class="rounded" alt="SI-LSP">
      </a>
      <!-- End Logo -->
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Kelola Data Permohonan</li>
        </ol>
      ...
      <section class="content">
        ...
        <?php
        // Cek Status permohonan
        $sql =  $conn->query("SELECT `permohonan`.`rekomendasi` FROM `permohonan` , `asesi` 
        WHERE permohonan.id_asesi = asesi.id_asesi 
          AND asesi.email = '$email' "); $data = mysqli_fetch_assoc($sql);

        $belum = 'hidden'; $proses = $belum ; $tolak = $belum;
        
        if ( $data['rekomendasi'] == '-') {
          $belum = '';
        }

        if ( $data['rekomendasi'] == 'diterima') {
          $proses = '';
        }

        if ( $data['rekomendasi'] == 'tidak diterima') {
          $tolak = '';
        }
        ...
        <!-- kalau belum di validasi -->
        <div class="box box-widget" style="margin-bottom: 10px;background-color: #FDFDFD" <?php echo $belum?>>
          ...
          <div class="alert alert-warning alert-dismissible">
            ...
            <button type="button" class="close" 
              ...
              Permohonan asesmen Anda belum di validasi, silahkan menunggu hingga permohonan asesmen divalidasi
        ...
        <!-- kalau diterima -->
        <div class="box box-widget" style="margin-bottom: 10px;background-color: #FDFDFD" <?php echo $proses?>>
          ...
          <div class="alert alert-success alert-dismissible">
            ...
            <button type="button" class="close" 
              ...
              Permohonan asesmen Anda diterima, silahkan lanjut dengan melakukan <a href="index.php?page=asesmen_mandiri" data-toogle="tooltip" data-placement="top" title="Lanjut Asesmen Mandiri"> Asesmen Mandiri </a>
        ...
        <!-- kalau ditolak -->
        <div class="box box-widget" style="margin-bottom: 10px;background-color: #FDFDFD" <?php echo $tolak?>>
          ...
          <div class="alert alert-danger alert-dismissible">
            ...
            <button type="button" class="close" 
              ...
              Permohonan asesmen Anda ditolak. Silahkan melihat catatan untuk detail lebih lanjut.
                  ...
                  <div class="panel-body">
                    ...
                    <div class="box box-danger">
                      ...
                      <?php
                        ...
                        FROM `akun` , `asesi`, `permohonan` WHERE `permohonan`.`id_asesi` = `asesi`.`id_asesi` AND `asesi`.`email` = `akun`.`email` AND `permohonan`.`id_asesi` = '$id_asesi';");
            ...
            <div class="panel box">
                ...
                <div id="DataSertifikasi" class="panel-collapse collapse in">
                  ...
                  <?php
                    ...
                    FROM `permohonan` , `skema_sertifikasi` WHERE `permohonan`.`id_skema`=`skema_sertifikasi`.`id_skema` AND `permohonan`.`id_asesi` = '$id_asesi' ;");
                      ...
                      <div class="form-row col-md-12">
                        ...
                        <table class="table table-bordered">
                          ...
                          <?php
                            ...
                            AND `permohonan`.`id_asesi` = '$id_asesi' ;"); $no = 1;
            ...
            <div class="panel box">
                  ...
                  <div id="KelengkapanPemohon" class="panel-collapse collapse in">
                    ...
                    <div class="panel-body box-body">
                        ...
                        <div class="box-body">
                          ...
                          <table class="table table-bordered">
                            ...
                            <tbody>
                              ...
                              AND `permohonan`.`id_asesi` = `asesi`.`id_asesi` AND `asesi`.`email` = '$email'  ");
                        ...
                        <div class="box-header with-border">
                          ...
                          <!-- <a data-toggle="collapse" data-parent="#accordion" href="#DataPribadi"> -->
                            <h4 class="panel-title with-border">
                              ...
                              <i class="fa fa-user"> Kelengkapan Persyaratan Dasar Pemohon Sertifikasi </i>
                          ...
                          <div class="box-body">
                            ...
                            <table class="table table-bordered">
                              ...
                              <thead>
                                <tr>
                                  <th width="10%">No</th>
                                  <th width="20%">Syarat Dasar</th>
                                  <th width="40%">Dokumen Syarat Dasar</th>
                                  <th width="30%">Penilaian</th>
                                </tr>
                              </thead>
                              ...
                              <tbody>
                                ...
                                <?php
                                  $sql = $conn->query("SELECT `syarat_dasar`.`no_syarat` , `syarat_dasar`.`syarat` ,  `syarat_permohonan`.`file_syarat_dasar` , `syarat_permohonan`.`terpenuhi`
                                    FROM `permohonan` , `syarat_dasar` , `syarat_permohonan` , `asesi` WHERE `permohonan`.`id_skema` = `syarat_dasar`.`id_skema` 
                                    AND `syarat_dasar`.`id_syarat`= `syarat_permohonan`.`id_syarat` AND `syarat_permohonan`.`id_permohonan` = `permohonan`.`id_permohonan` 
                                    AND `permohonan`.`id_asesi` = `asesi`.`id_asesi` AND `asesi`.`email` = '$email';"); 
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <a class="btn btn-primary btn-block"
                                      data-toggle="modal" data-target="#ModalCekSyaratDasar<?php echo $no; ?>">
                                  ...
                                  <td>
                                    ...
                                    <div>
                                      ...
                                      <select class="form-control" disabled>
                                        <option selected disabled><?php echo $syarat_dasar['terpenuhi']?></option>
                                  ...
                                  <div id="ModalCekSyaratDasar<?php echo $no; ?>" class="modal fade" role="dialog" tabindex="-1">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                      ...
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body mb-0 p-0">
                                          ...
                                          <iframe class="embed-responsive-item" style="height: 100%; width: 100%;" 
                                          src="uploads\Asesi\<?php echo $pribadi['id_asesi']?>\Syarat Permohonan\<?php echo $syarat_dasar['file_syarat_dasar'] ;?>"></iframe>
                                          </div>
                      ...
                      <!-- End Box Syarat Dasar -->




                      <!-- Box Kompetensi yang relevan -->
                      <div class="box box-danger">
                        ...
                        <div class="box-header with-border">
                          ...
                          <!-- <a data-toggle="collapse" data-parent="#accordion" href="#DataPribadi"> -->
                            <h4 class="panel-title with-border">
                              ...
                              <i class="fa fa-user"> Bukti Kompetensi yang Relevan Pemohon Sertifikasi </i>
                        ...
                        <table class="table table-bordered">
                          ...
                          <thead>
                            <tr>
                              <th width="10%">No</th>
                              <th width="20%">Bukti Kompetensi</th>
                              <th width="40%">Dokumen Bukti Kompetensi</th>
                              <th width="30%">Penilaian</th>
                            </tr>
                          </thead>
                          ...
                          <tbody>
                            ...
                            <?php
                              $sql = $conn->query("SELECT `bukti_kompetensi`.`bukti` , `bukti_kompetensi`.`lampiran` , `bukti_kompetensi`.`status_lampiran`  FROM `bukti_kompetensi` , `permohonan` , `asesi` 
                              WHERE `bukti_kompetensi`.`id_permohonan` = `permohonan`.`id_permohonan` AND `permohonan`.`id_asesi` = `asesi`.`id_asesi` 
                              AND `asesi`.`email` = '$email' ;"); 

                              $no = 1 ;

                                while ( $bukti_kompetensi = mysqli_fetch_assoc($sql) ){ 
                            ...
                            <tr>
                              ...
                              <td>
                                <?php echo $bukti_kompetensi['bukti']?>
                              </td>

                              <td>

                                <a class="btn btn-primary btn-block"
                                  data-toggle="modal" data-target="#ModalCekBuktiKompetensi<?php echo $no; ?>">

                                  <i class="fa fa-search" style="margin-right: 3px;"></i>
                                  Lihat Bukti Kompetensi
                              ...
                              <td>
                                ...
                                <div>
                                  ...
                                  <select disabled class="form-control">
                                    <option value="" selected disabled ><?php echo $bukti_kompetensi['status_lampiran']?></option>
                              ...
                              <!-- Modal Cek Bukti Kompetensi -->
                              <div id="ModalCekBuktiKompetensi<?php echo $no; ?>" class="modal fade" role="dialog" tabindex="-1">
                                ...
                                <div class="modal-dialog modal-lg">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body mb-0 p-0">
                                      ...
                                      <iframe class="embed-responsive-item" style="height: 100%; width: 100%;" 
                                      src="uploads\Asesi\<?php echo $pribadi['id_asesi']?>\Bukti Kompetensi\<?php echo $bukti_kompetensi['lampiran'] ;?>"></iframe>
                                      </div>
                              ...
                              <!-- End Modal Cek Bukti Kompetensi -->
                      ...
                      <!-- End Box Kompetensi yang relevan -->
