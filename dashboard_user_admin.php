...
$data = mysqli_fetch_assoc ( $conn->query( "SELECT `id_UA` FROM `user_administrasi` WHERE `email` = '$email';" ) ) ;
...
<head>
  ...
  <title>SI-LSP | Dashboard User Admin</title>
  <!-- Favicon -->
        ...
        <div class="row" style="margin-top:10px;">
          ...
          <div class="col-md-8"> <!-- Sisi Kanan -->
            ...
            <div style="margin-bottom:5px;padding:5px 10px;background-color: #FDFDFD !important;border-radius:3px;">
              <small style="font-weight:bold;color:#3c8dbc;font-size:13px;">Menu User Administrasi</small>
            </div>
            
            <div class="btn-group btn-group-justified"> <!-- 3 Menu atas -->
            
              <!-- Menu Data Diri -->
              <a href="index.php?page=kelola_skema_sertifikasi" class="btn btn-menu" style="white-space: normal">
                <img src="img/file.png" class="icon-menu" alt="Pulsa" style="margin-bottom:7px;">
                <br> Kelola Skema Sertifikasi </br>
              </a>
                        
              
              <!-- Menu Ajukan Permohonan Sertifikasi -->
              <a href="index.php?page=kelola_asesi" class="btn btn-menu" style="white-space: normal">
                <img src="img/member.png" class="icon-menu" alt="Pulsa" style="margin-bottom:7px; white-space: normal">
                <br> Kelola Pengguna </br>
              </a>
                        
              <!--  Menu 3 -->
              <a href="index.php?page=kelola_permohonan_masuk" class="btn btn-menu" style="white-space: normal">
                <img src="img/file.png" class="icon-menu" alt="Pulsa" style="margin-bottom:7px;" >
                <br> Kelola Permohonan </br>
              </a>
            ...
            <div class="btn-group btn-group-justified"> <!-- 3 Menu dibawah -->
              ...
              <!-- Menu 4 -->
              <a href="index.php?page=kelola_berita_sertifikasi" class="btn btn-menu" style="white-space: normal">
                <img src="img/file.png" class="icon-menu" alt="Pulsa" style="margin-bottom:7px;">
          ...
          <div class="box box-widget" style="margin-bottom: 10px;background-color: #FDFDFD">
            <div class="alert alert-warning alert-dismissible">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                ...
                Segera Lakukan Validasi Permohonan Sertfikasi
