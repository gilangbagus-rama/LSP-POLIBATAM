    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Kelola User Adminsitrasi</li>
        </ol>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-content">
              ...
              <div class="modal-header">
                ...
                <h4 class="modal-title">Tambah User Adminsitrasi</h4>
              </div>
              <!-- End Modal Header -->
              ...
              <div class="modal-body">
                ...
                <form role="form" method="post" enctype="multipart/form-data" id="form_tambah_asesor"
                  ...
                  <div class="form-group">
                    ...
                    <button type="submit" id="btn-add" class="btn btn-primary btn-block">Tambahkan User Adminsitrasi</button>
            ...
            <table id="load" class="table table-bordered table-striped">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <th width="5%">No</th>
                  <th width="12%">Nomor User Administrasi</th>
                  <th width="12%">Nama User Administrasi</th>
              ...
              <tbody>
                ...
                <?php
                  ...
                  $sql = $conn->query("SELECT `user_administrasi`.`id_UA` , `user_administrasi`.`nomor_UA` , `akun`.`nama` , `akun`.`email` ,`akun`.`no_hp`
                  FROM `user_administrasi` , `akun` WHERE `akun`.`email` = `user_administrasi`.`email` AND `akun`.`role` = 'User Administrasi' ");
                    ...
                    <td>
                      ...
                      <center>
                        ...
                        <div class="dropdown show">
                          ...
                          data-toggle="dropdown">Aksi   <span class="caret"></span>
                          </button>
                          ...
                          <div class="dropdown-menu" id="dropdownMenuLink">
                            ...
                            <!-- Menu Edit Skema -->
                            <li style="padding-bottom: 10px" data-toggle="tooltip" 
                            data-placement="top" title="Edit Asesor <?php echo $data['nama'] ?>">


                              <a href="#" class="dropdown-item"
                                data-toggle="modal" 
                                data-target="#ModalEditAsesor<?php echo $no ?>">
                            ...
                            <!-- Menu Hapus Skema -->
                            <li style="padding-bottom: 10px" data-toggle="tooltip" 
                            data-placement="top" title="Hapus Asesor <?php echo $data['nama'] ?>">


                              <a href="#" class="dropdown-item"
                                data-toggle="modal" 
                                data-target="#ModalHapusAsesor<?php echo $no?>">
                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document" aria-labelledby="ModalHapusSkemaTitle" aria-hidden="true">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <center>
                                  <h4>Yakin ingin menghapus Asesi <?php echo $data['nama'] ?> ? </h4>
                                </center>
                                ...
                                <center>
                                  ...
                                  yang bersangkutan dengan Asesi yang akan dihapus !
