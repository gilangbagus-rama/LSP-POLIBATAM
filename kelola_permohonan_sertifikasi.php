    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Kelola Permohonan Sertifikasi</li>
        </ol>
            ...
            <table id="load" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <?php
                  ...
                  $sql = $conn->query("SELECT permohonan.id_permohonan , permohonan.id_asesi, 
                ...
                ?>
                    ...
                    <td>
                      ...
                      <center>
                        ...
                        <div class="dropdown show">
                          ...
                          <div class="dropdown-menu" id="dropdownMenuLink" aria>


                            <!-- Menu Cek Kelengkapan Bukti Sertifikasi -->
                            <li style="padding-bottom: 10px" data-toggle="tooltip" data-placement="top" 
                            title="Cek Kelengkapan Bukti Sertifikasi Asesi <?php echo $data['nama']; ?>">


                              <a href="index.php?page=kelola_kelengkapan_bukti_sertifikasi" class="dropdown-item">

                                <i class="fa fa-check"></i> 
                                Cek Kelengkapan Bukti Sertifikasi

                              </a>


                            </li>
                            <!-- End Menu Cek Kelengkapan Bukti Sertifikasi -->


                            <!-- Menu Ubah Status Permohonan -->
                            <!-- <li style="padding-bottom: 10px" data-toggle="tooltip" data-placement="top" 
                            title="Ubah Status Permohonan Sertifikasi Asesi">
                            ...
                            <!-- End Menu Ubah Status Permohonan -->
                  ...
                  <div id="ModalHapusSkema<?php echo $data['id_skema']; ?>" class="modal fade" tabindex="-1" role="dialog">
                  ...
                  <div id="ModalEditSkema<?php echo $data['id_skema']; ?>" class="modal fade" role="dialog">
