              ...
              <tbody>
                ...
                <?php
                  ...
                  $sql = $conn->query("SELECT permohonan.id_permohonan , permohonan.id_asesi, 
                                      ...
                                      AND permohonan.rekomendasi = 'Diterima';");
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                              ...
                              <a href="index.php?page=detil_permohonan&&id_permohonan=<?php echo $data['id_permohonan'];?>" class="btn btn-primary">

                                <i class="fa fa-eye"></i> 
                                Lihat Detil Permohonan
