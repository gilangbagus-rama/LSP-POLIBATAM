      ...
      <section class="content">
          ...
          <div class="col col-md-12 col-lg-12">
            ...
            <!-- Judul -->
                <div class="panel-heading text-center" style="color: white">
                  <a data-toggle="collapse" data-parent="#accordion" href="#PermohonanSertifikasi">
          ...
          <div class="col col-lg-5 panel-group">
            ...
            <div class="panel box">
              ...
              <div class="box-body">
                ...
                <a href="index.php?page=asesmen_mandiri&&id_permohonan=<?php echo $id_permohonan?>" data-toogle="tooltip" data-placement="top" title="Lanjut Asesmen Mandiri">
                  <button class="btn btn-primary btn-block" 
                  <?php echo $disabled ?> <?php echo $cek_asesmen_mandiri?>>Asesmen Mandiri</button>
                </a>
        ...
        <div class="row" <?php echo $hidden ?>>
          ...
          <div class="col col-md-12 col-lg-12">
            ...
            <!-- Judul -->
                <div class="panel-heading text-center" style="color: white">
                  <a data-toggle="collapse" data-parent="#accordion" href="#AsesmenMandiri">
                    <h4 class="panel-title with-border">
                ...
                <!-- Data Permohonan Sertifikasi -->
        <div class="row" id="AsesmenMandiri" <?php echo $hidden ?>>
