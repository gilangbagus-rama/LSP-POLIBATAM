...
<head>
  ...
  <title>SI-LSP | Kelola Validasi MAPA</title>
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                              ...
                              <a class="btn btn-primary" href="index.php?page=validasi_mapa&&id_permohonan=<?php echo $id_permohonan ?>&&id_mapa=<?php echo $data['id_mapa']?>&&id_unit=<?php echo $id_unit?>">
