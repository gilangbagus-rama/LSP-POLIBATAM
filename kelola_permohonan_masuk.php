    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Kelola Permohonan Masuk</li>
        </ol>
              ...
              <tbody>
                ...
                <?php
                  ...
                  $sql = $conn->query("SELECT permohonan.id_permohonan , permohonan.id_asesi, 
                                      ...
                                      AND permohonan.status_permohonan = 'Menunggu Validasi Permohonan';");
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                              ...
                              <a href="index.php?page=kelola_kelengkapan_bukti_sertifikasi&&permohonan=<?php echo $data['id_permohonan'];?>" 
