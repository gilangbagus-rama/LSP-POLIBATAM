...
<head>
  ...
  <title>SI-LSP | Kelola Skema Sertifikasi</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href='' ><i class="fa fa-file"></i>Kelola Skema Sertifikasi</a></li>
        </ol>
      ...
      <section class="content">
        ...
        <div id="ModalTambahSkemaSertifikasi" class="modal fade" role="dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form role="form" method="post" enctype="multipart/form-data" id="form_tambah_skema"
                  action="proses_user_admin.php?aksi=tambah_skema" >
            ...
            <table id="load" class="table table-bordered table-striped">
              ...
              <thead>
                ...
                <tr>
                  <th width="5%">No.</th>
                  <th width="15%">#</th>
                  <th width="12%">ID Skema</th>
                  <th width="11%">Nomor Skema</th>
                  <th width="15%">Nama Skema</th>
                  <th width="20%">File Skema</th>
                  <th width="15%">Validasi Admin</th>
              ...
              <tbody>
                ...
                <?php
                  ...
                  $sql = $conn->query("SELECT `skema_sertifikasi`.`id_skema` , `skema_sertifikasi`.`nomor_skema` , `skema_sertifikasi`.`nama_skema` , `skema_sertifikasi`.`file_skema` , `skema_sertifikasi`.`validasi_id_admin` , `akun`.`nama` 
                  FROM `skema_sertifikasi` , `user_administrasi` , `akun` 
                  WHERE `skema_sertifikasi`.`validasi_id_admin` = `user_administrasi`.`id_UA` AND `user_administrasi`.`email` = `akun`.`email` ;");
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="dropdown show text-center">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <!-- Menu Edit Skema -->
                          <li style="padding-bottom: 10px" data-toggle="tooltip" data-placement="top" title="Lihat File Skema <?php $data['nama_skema'] ?>">


                            <a href="#" class="dropdown-item"
                              data-toggle="modal" data-target="#ModalLihatFileSkema<?php echo $no ?>">
                    ...
                    <!-- Id Skema -->
                    <td> 
                      <?php echo $data['id_skema']; ?> 
                    </td>


                    <!-- Nomor Skema -->
                    <td> 
                      <?php echo $data['nomor_skema']; ?> 
                    </td> 
                    ...
                    <!-- Nama File -->
                    <td> 
                      <?php echo $data['file_skema']; ?> 
                    </td> 

                    <td> 
                      <?php echo $data['validasi_id_admin']; ?> | <?php echo $data['nama']; ?> 
                    </td> 
                    ...
                    <!-- Button Aksi -->
                                  ...
                                  <div id="ModalLihatFileSkema<?php echo $no ?>" class="modal fade" role="dialog" tabindex="-1">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                      ...
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                          ...
                                          <h4 class="modal-title">File Skema Sertifikasi <?php echo $data['nama_skema']?></h4>
                                        ...
                                        <div class="modal-body mb-0 p-0">
                                          ...
                                          src="uploads\SI-LSP\Skema Sertifikasi\<?php echo $data['file_skema']; ?>"
                                          title="Skema Sertifikasi <?php echo $data['nama_skema']?>"></iframe>
                                          </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document" aria-labelledby="ModalHapusSkemaTitle" aria-hidden="true">
                      ...
                      <div class="modal-content">
                        ...
                        <form action="proses_user_admin.php?aksi=hapus_skema" role="form" method="post">
                          ...
                          <!-- Input hidden id_skema -->
                          <input type="hidden" id="id_skema" name="id_skema" value="<?php echo $data['id_skema']; ?>">
                          <input type="hidden" id="file_skema" name="file_skema" value="<?php echo $data['file_skema'];?>">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form role="form" method="post" enctype="multipart/form-data"
                            ...
                            <input type="hidden" id="id_skema" name="id_skema" value="<?php echo $data['id_skema']; ?>">
                            <input type="hidden" id="namaFile_lama" name="namaFile_lama" value="<?php echo $data['file_skema']; ?>">
                            ...
                            <div class="form-group has-feedback">
                              ...
                              <input type="text" readonly name="file_lama" id="file_lama"
                                value="<?php echo $data['file_skema']; ?>" class="form-control" />
                              <br>
                            ...
                            <div class="form-group">
                              ...
                              <button type="submit" id="btn-add" class="btn btn-primary btn-block">Edit Skema Sertifikasi</button>
