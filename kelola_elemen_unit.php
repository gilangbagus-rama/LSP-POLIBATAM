...
<head>
  ...
  <title>SI-LSP | Kelola Elemen Unit</title>
...
<body class="hold-transition skin-blue-light sidebar-mini">
  ...
  $sql = $conn->query("SELECT `unit_skema`.`judul_unit` 
  FROM `unit_skema` 
  WHERE `unit_skema`.`id_unit` = '$id_unit' ");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Elemen Unit Skema</li>
      </ol>
    </section>
    ...
    $sql = $conn->query("SELECT * FROM `unit_skema` WHERE id_skema = '$id_skema' AND `id_unit` = '$id_unit'");
    $data = mysqli_fetch_assoc($sql);
    ...
    <section class="content">
      ...
      <div class="box box-widget" style="margin-bottom: 20px;background-color: #FDFDFD">
        ...
        <div class="box-body">
          ...
          <a class="btn btn-primary btn-block"
            ...
            data-toggle="modal" data-target="#ModalTambahElemenUnit">
      ...
      <div id="ModalTambahElemenUnit" class="modal fade" role="dialog">
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              ...
              <h4 class="modal-title">Tambah Elemen Unit</h4>
            </div>
            <!-- End Modal Header -->
            ...
            <div class="modal-body">
              ...
              <form role="form" method="post" enctype="multipart/form-data"
                action="proses_user_admin.php?aksi=tambah_elemen_unit" >
                  ...
                  <!-- End Input hidden ID Skema , ID Unit -->
                ...
                <div class="form-group has-feedback">
                  ...
                  <textarea type="text" name="elemen_unit" id="elemen_unit"
                    class="form-control" rows="2" placeholder="Masukkan Elemen Unit"
                    required=""></textarea>
                ...
                <div class="form-group">
                  ...
                  <button type="submit" id="btn-add_elemen_unit" class="btn btn-primary btn-block">Tambahkan Elemen Unit</button>
              ...
              <!-- End Form Tambahkan Elemen Unit -->
        ...
        <div class="box-body table-responsive">
          ...
          <table id="load" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                $sql = $conn->query("SELECT `elemen_unit`.`id_elemen` , `elemen_unit`.`id_unit` , 
                      `elemen_unit`.`no_elemen` , `elemen_unit`.`elemen` , `unit_skema`.`judul_unit` 
                      FROM `elemen_unit` , `unit_skema` 
                      WHERE `elemen_unit`.`id_unit`=`unit_skema`.`id_unit` 
                      AND `elemen_unit`.`id_unit` = '$id_unit' ");
                  ...
                  <center>
                    ...
                    <div class="dropdown show">
                      ...
                      <div class="dropdown-menu" id="dropdownMenuLink" aria-labelledby>
                        ...
                        <li style="padding-bottom: 10px" data-toggle="tooltip" data-placement="top" title="Edit Elemen Unit">
                            
                            <a href="#" class="dropdown-item"
                              data-toggle="modal" data-target="#ModalEditElemenUnit<?php echo $no; ?>">

                              <i class="fa fa-pencil"></i> Edit Elemen Unit
                            </a>
                        ...
                        <li style="padding-bottom: 10px" data-toggle="tooltip" data-placement="top" title="Hapus Elemen Unit">
                            ...
                            <a href="#" class="dropdown-item"
                              data-toggle="modal" data-target="#ModalHapusElemenUnit<?php echo $no; ?>">

                              <i class="fa fa-trash"></i> Hapus Elemen Unit
                            </a>

                        </li>


                        <li style="padding-bottom: 10px" data-toggle="tooltip" data-placement="top" title="Kelola KUK">



                          <a href="index.php?page=kelola_kuk&&id_skema=<?php echo $id_skema ?>&&id_unit=<?php echo $id_unit ?>&&id_elemen=<?php echo $data['id_elemen']; ?>" class="dropdown-item">

                            <i class="fa fa-gear"></i> Kelola Kriteria Unjuk Kerja (KUK)
                          </a>
                ...
                <div id="ModalHapusElemenUnit<?php echo $no ?>" class="modal fade" tabindex="-1" role="dialog">
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document" aria-labelledby="ModalHapusSkemaTitle" aria-hidden="true">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <center>
                          <h3><strong>Hapus Elemen Unit</strong></h3>
                        </center>
                        <br>
                        <center>
                          <h4>Yakin ingin menghapus Elemen Unit ? </h4>
                        </center>
                      
                      </div>
                      
                      <form action="proses_user_admin.php?aksi=hapus_elemen_unit"  role="form" method="post">
                        ...
                        <!-- Input Hidden ID Elemen -->

                        <input type="hidden" id="id_elemen" name="id_elemen" value="<?php echo $data['id_elemen']; ?>">

                        <!-- End Input Hidden Id Elemen -->
                ...
                <!-- Modal Tambah Skema Sertifikasi -->
                <div id="ModalEditElemenUnit<?php echo $no ?>" class="modal fade" role="dialog">
                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title">Edit Elemen Unit</h4>
                      </div>
                      <!-- End Modal Header -->
                      ...
                      <div class="modal-body">
                        ...
                        <form role="form" method="post" enctype="multipart/form-data"
                          action="proses_user_admin.php?aksi=edit_elemen_unit" >
                          ...
                          <div class="form-group has-feedback">
                            ...
                            <textarea type="text" name="elemen_unit" 
                              id="elemen_unit" class="form-control"
                              required=""><?php echo $data['elemen']?></textarea>
                          ...
                          <div class="form-group">
                            ...
                            <button type="submit" id="btn-add_elemen_unit" class="btn btn-primary btn-block">Edit Elemen Unit</button>
