...
$token    = $_SESSION['token'];
  ...
  if ( !isset( $_SESSION['token'] ) || empty( $_SESSION['token'] ) ||
      ...
      $_SESSION['role'] != 'User Administrasi' ) {
...
<head>
  ...
  <title>SI-LSP | Detil Permohonan Asesi</title>
      ...
      <section class="content">
        ...
        <div class="box box-widget" style="margin-bottom: 10px;background-color: #FDFDFD">
          ...
          <div class="box-body">
            ...
            <a <?php echo $disabled ?> class="btn btn-primary" href="index.php?page=kelola_data_asesmen_mandiri&&id_permohonan=<?php echo $id_permohonan?>">Lihat Asesmen Mandiri</a>
            <a <?php echo $disabled ?> class="btn btn-primary" href="index.php?page=kelola_validasi_mapa&&id_permohonan=<?php echo $id_permohonan?>">Validasi MAPA</a>
